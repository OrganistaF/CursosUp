...
function startGame() {
    myGamePiece = new component(30, 30, "happyface.jpg", 10, 120, "image");
    myGameArea.start();
}
...
var myGameArea = {
    ...
    start : function() {
        ...
        this.canvas.setAttribute("border", "1px solid")
        this.canvas.setAttribute("style", "background-color: gray;")
